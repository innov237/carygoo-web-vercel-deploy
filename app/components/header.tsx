      ...
      <nav className="bg-white border-b border-gray-200 py-4 shadow-sm">
        <div className="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
          ...
          <div className="items-center justify-between hidden w-full lg:flex lg:w-auto lg:order-1">
            <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
              ...
              <li>
                <a href="/partners" className="block py-2 pl-3 pr-4 text-gray-600 hover:text-red-600 lg:hover:text-red-600 lg:p-0 transition-colors duration-200">Partenaire</a>
              </li>
              <li>
                <a href="/contact" className="block py-2 pl-3 pr-4 text-gray-600 hover:text-red-600 lg:hover:text-red-600 lg:p-0 transition-colors duration-200">Contact</a>
              </li>
            </ul>
          </div>
        </div>
        ...
        >
          ...
          <ul className="flex flex-col p-4 space-y-2">
            ...
            <li>
              <a href="/partners" className="block px-4 py-3 text-2xl font-semibold text-gray-900 hover:text-red-600 hover:bg-gray-100 rounded-lg transition-colors" onClick={toggleMenu}>Partenaire</a>
            </li>
            <li>
